...
assert.match(css, /@media \(max-width: 360px\)[\s\S]*?\.homepage-value-heading h2 \{ font-size: 23px; \}/);
...
assert.match(css, /@media \(min-width: 961px\) and \(max-width: 1599px\)[\s\S]*?\.phase3-capabilities > \.container \{ grid-template-columns: 1fr/);
