...
const requiredBases = [
  ...
  'eastland-facebook-presence', 'eastland-google-discovery', 'eastland-website-desktop', 'eastland-website-mobile-detail'
];
...
assert.ok(html.includes('Facebook as the primary online presence'));
